        ...
        try {
            ...
            switch (toolName) {
                ...
                case 'aem_create_page':
                    result = await this.services.pageOperations.createPage(args.parentPath, args.pageName, {
                ...
                case 'aem_create_user':
                    result = await this.services.userAdministration.createUser(args.userId, args.password, { profile: args.profile });
                    break;
                ...
                case 'aem_update_replication_agent':
                    result = await this.services.replicationOperations.updateReplicationAgent(args.agentName, args.updates);
                    break;
                case 'aem_schedule_publish':
                    result = await this.services.replicationOperations.schedulePublish(args.contentPath, {
                ...
                case 'aem_start_workflow':
                    result = await this.services.workflowOperations.startWorkflow(args.workflowModel, args.payload, { workflowTitle: args.title });
                    break;
                ...
                case 'aem_complete_workflow_task':
                    result = await this.services.workflowOperations.completeWorkflowTask(args.taskId, args.action, {
                        comment: args.comment,
                ...
                case 'aem_create_content_fragment':
                    result = await this.services.contentFragmentOperations.createContentFragment(args.parentPath, args.fragmentName, {
                        model: args.model,
                        title: args.title,
                        description: args.description,
                ...
                case 'aem_update_content_fragment':
                    result = await this.services.contentFragmentOperations.updateContentFragment(args.fragmentPath, {
                        elements: args.elements,
                        title: args.title,
                        description: args.description,
                        tags: args.tags,
                ...
                case 'aem_delete_content_fragment':
                    result = await this.services.contentFragmentOperations.deleteContentFragment(args.fragmentPath, {
                        force: args.force,
                        checkReferences: args.checkReferences
                    });
                    break;
                case 'aem_create_content_fragment_model':
                    result = await this.services.contentFragmentOperations.createContentFragmentModel(args.parentPath, args.modelName, {
                        title: args.title,
                        description: args.description,
                        elements: args.elements,
                        properties: args.properties
                ...
                case 'aem_create_content_fragment_variation':
                    result = await this.services.contentFragmentOperations.createContentFragmentVariation(args.fragmentPath, args.variationName, {
                        title: args.title,
                        description: args.description,
                        elements: args.elements,
                ...
                case 'aem_update_content_fragment_variation':
                    result = await this.services.contentFragmentOperations.updateContentFragmentVariation(args.fragmentPath, args.variationName, {
                        title: args.title,
                        description: args.description,
                        elements: args.elements,
                        isMaster: args.isMaster
                ...
                case 'aem_delete_content_fragment_variation':
                    result = await this.services.contentFragmentOperations.deleteContentFragmentVariation(args.fragmentPath, args.variationName);
                    break;
